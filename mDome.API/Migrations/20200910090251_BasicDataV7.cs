...
{
    public partial class BasicDataV7 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Notification",
                columns: new[] { "NotificationId", "NotifDateTime", "NotifText", "UserId" },
                values: new object[,]
                {
                    { 9, new DateTime(2020, 9, 10, 10, 37, 4, 890, DateTimeKind.Unspecified), "This is a notification", 8 },
                    { 10, new DateTime(2020, 9, 10, 10, 37, 4, 890, DateTimeKind.Unspecified), "This is another notification", 8 }
                });
            ...
            migrationBuilder.InsertData(
                table: "Request",
                columns: new[] { "RequestId", "NameOfUser", "RequestDate", "RequestText", "UserId" },
                values: new object[,]
                {
                    { 4, "mobile", new DateTime(2020, 9, 10, 10, 38, 15, 500, DateTimeKind.Unspecified), "I request this", 8 },
                    { 5, "mobile", new DateTime(2020, 9, 10, 10, 38, 15, 500, DateTimeKind.Unspecified), "And i request also this", 8 }
                });
